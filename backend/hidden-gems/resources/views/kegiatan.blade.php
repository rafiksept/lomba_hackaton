                            ...
                            <div class="d-none d-md-block">
                                <div class="filters">
                                    <div class="filter-item">
                                        ...
                                        <div id="floating-label-10" class="form-floating mb-3"><select class="form-select" for="floatinginput" placeholder="HGsOFT" style="font-family: Poppins, sans-serif;font-size: 14px;width: 224px;">
                            ...
                            <div class="d-md-none"><a class="btn btn-link d-md-none filter-collapse" data-bs-toggle="collapse" aria-expanded="false" aria-controls="filters" href="#filters" role="button">Filters<i class="icon-arrow-down filter-caret"></i></a>
                                <div class="collapse" id="filters">
                                    <div class="filters">
                                        <div class="filter-item">
                                            <h3>RAM</h3>
                                            <div id="floating-label-19" class="form-floating mb-3"><select class="form-select" for="floatinginput" placeholder="HGsOFT">
                                                    <optgroup label="This is a group">
                                                        <option value="1">This is item 1</option>
                                                        <option value="2">This is item 2</option>
                                                        <option value="3">This is item 3</option>
                                                    </optgroup>
                                                </select><label class="form-label" id="floating-label-20" for="floatinginput">Select ...</label></div>
                                        </div>
                                        <h3>ROM</h3>
                                        <div id="floating-label-21" class="form-floating mb-3"><select class="form-select" for="floatinginput" placeholder="HGsOFT">
                                                <optgroup label="This is a group">
                                                    <option value="1">This is item 1</option>
                                                    <option value="2">This is item 2</option>
                                                    <option value="3">This is item 3</option>
                                                </optgroup>
                                            </select><label class="form-label" id="floating-label-22" for="floatinginput">Select ...</label></div>
                                        <div class="filter-item"></div>
                                        <h3>Processor</h3>
                                        <div id="floating-label-23" class="form-floating mb-3"><select class="form-select" for="floatinginput" placeholder="HGsOFT">
                                                <optgroup label="This is a group">
                                                    <option value="1">This is item 1</option>
                                                    <option value="2">This is item 2</option>
                                                    <option value="3">This is item 3</option>
                                                </optgroup>
                                            </select><label class="form-label" id="floating-label-24" for="floatinginput">Select ...</label></div>
                                        <div id="floating-label-25" class="form-floating mb-3"></div>
                                        <div class="filter-item">
                                            <h3>Layar</h3>
                                            <div id="floating-label-26" class="form-floating mb-3"><select class="form-select" for="floatinginput" placeholder="HGsOFT">
                                                    <optgroup label="This is a group">
                                                        <option value="1">This is item 1</option>
                                                        <option value="2">This is item 2</option>
                                                        <option value="3">This is item 3</option>
                                                    </optgroup>
                                                </select><label class="form-label" id="floating-label-27" for="floatinginput">Select ...</label></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-sm-6 col-lg-4 mb-4">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text text-muted" style="font-family: Poppins, sans-serif;">{{$kegiatan -> description}}</p>
                                                        <p class="fw-bold text-dark mb-2" style="text-align: left;color: var(--bs-black);margin-top: -12px;font-family: Alatsi, sans-serif;font-weight: bold;font-size: 24px;">{{$kegiatan -> harga}}</p>
                                                        <p class="fw-bold text-dark mb-2" style="text-align: right;color: var(--bs-danger);font-family: Abel, sans-serif;font-size: 18px;"><span style="color: rgb(0, 0, 0);">&nbsp;</span><img src="{{asset('img/star.svg')}}" style="width: 23px;"><span style="color: rgb(0, 0, 0);">{{$kegiatan -> rating}}/5</span></p><button class="btn btn-primary" type="button" style="padding-left: 37px;transform: scale(0.75);margin-top: 3px;margin-left: -10px;"><i class="icon-basket"></i><a href="/keranjangAction/{{$kegiatan -> id}}">&nbsp;Add</a></button>
                                                    </div>
                                                </div>
                                            </div>
